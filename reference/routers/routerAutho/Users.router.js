...
users.post("/registration", validator.validtorBodySingUP, validator.validationResult, ControllerUsers.signUp);
...
users.get("/all-users", checkJwt, checkRole("admin"), ControllerUsers.getAllUsers);
